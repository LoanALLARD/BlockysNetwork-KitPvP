package fr.dwade.blokcyskp.Menu;
...
public class KitMenu implements Listener {
    ...
    private void giveKitGuerrier(Player player) {
        ...
        player.sendMessage("§cTu as reçu le kit Guerrier !");
    }
    ...
    private void giveKitMage(Player player) {
        ...
        player.getInventory().setHeldItemSlot(0);
        player.sendMessage("§bTu as reçu le kit Mage !");
    }
    
    @EventHandler
	public void onPlayerJoin(PlayerJoinEvent event) {
		Player player = event.getPlayer();
		joueurKitPris.put(player.getUniqueId(), false);
    ...
    public void onPlayerDeath(PlayerDeathEvent event) {
        ...
        player.sendMessage("[KP] Tu as été tué par " + player.getKiller() + " !");
        joueurKitPris.put(player.getUniqueId(), false);
		player.getInventory().clear();
    }
}
